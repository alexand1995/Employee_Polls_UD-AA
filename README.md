...
Welcome to the Poll App, a platform designed for engaging in polls, creating new ones, and climbing up the leaderboard by actively participating in these interactions. Developed using React and Redux, this project serves as the final assessment for the React & Redux course.
